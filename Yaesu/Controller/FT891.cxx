...
void FT891::OnBox(Fl_Button* o , void* v)
{
	...
	else if(o == SPL)
	{
		...
		{
			string s = Split::Set(SplitValue::OFF);
			m_port.writeString(s);
			SPL->color(FL_BACKGROUND_COLOR);
		...
		{
			string s = Split::Set(SplitValue::ON_5KU);
			m_port.writeString(s);
			SPL->color(FL_BLUE);
		}
		else if(SPL->color() == FL_BACKGROUND_COLOR)
		{
			string s = Split::Set(SplitValue::ON);
			m_port.writeString(s);
			SPL->color(FL_GREEN);
		}
		SPL->redraw();
